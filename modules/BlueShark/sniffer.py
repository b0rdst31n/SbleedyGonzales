...
if __name__ == '__main__':
    ...
    trimmed_path = os.getcwd().replace("/modules/BlueShark", "")
    # Display the libpcap logfile location
    if args.logfile != CaptureFiles.captureFilePath:
        CaptureFiles.captureFilePath = os.path.join(trimmed_path + "/results/", args.logfile)
    else:
