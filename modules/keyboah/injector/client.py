...
from injector.hid import keyboard_report, ascii_to_hid, Key, Mod
...
class KeyboardClient:
  ...
  def send_keyboard_combination(self, modifier, key, delay=0.004):
        ...
        press_report = keyboard_report(modifier, key)
        self.send_hex_report(press_report)
        time.sleep(delay)  # Delay to simulate key press
    
        # Release the combination
        release_report = keyboard_report()
        self.send_hex_report(release_report)
        time.sleep(delay)
